...
public class MazePlayerController : MonoBehaviour {
    ...
    private bool cameraValuesAreOnDefault = true;
    ...
    private void SwitchCameraValues() {
        Vector3 cameraLocalPosition = mainCamera.transform.localPosition;
        if (cameraValuesAreOnDefault) {
            cameraLocalPosition.z = -30f;
            cameraValuesAreOnDefault = false;
        }
        else {
            cameraLocalPosition.z = 0f;
            cameraValuesAreOnDefault = true;
        }
